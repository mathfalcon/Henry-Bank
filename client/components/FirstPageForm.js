...
import { KeyboardAwareScrollView } from "react-native-keyboard-aware-scroll-view";import styles from "../Styles/signInStyles.js";
import {  
  Text,
  Label,
  Form,  
    ...
    <SafeAreaView>
      <KeyboardAwareScrollView>
        ...
        <Form style={{ paddingHorizontal: 20 }}>
          ...
          <Item floatingLabel error={touched.name && errors.name ? true : false}>
          <Label>Name</Label>         
            <Input
              // placeholder="Name"              
          ...
          <Item floatingLabel error={touched.surname && errors.surname ? true : false}>          
              <Label>Surname</Label>
          ...
          <Item>
            <Picker
              onValueChange={handleChange('docType')}
          ...
          <Item floatingLabel error={touched.docNumber && errors.docNumber ? true : false}>
          ...
          <Item style={{marginTop: 10, marginBottom:0}} error={touched.birth && errors.birth ? true : false}>
            <DatePicker              
          ...
          <Item floatingLabel error={touched.phone && errors.phone ? true : false}>
          ...
          <Item floatingLabel error={touched.email && errors.email ? true : false}>
          <Label>Email</Label>
            <Input
              // placeholder="Email"
